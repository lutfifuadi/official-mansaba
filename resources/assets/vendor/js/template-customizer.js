...
TemplateCustomizer.LANGUAGES = {
  ...
  id: {
    ...
    theming_header: 'Tema',
    color_label: 'Warna Utama',
    theme_label: 'Tema',
    skin_label: 'Tampilan',
    semiDark_label: 'Semi Gelap',
    layout_header: 'Tata Letak',
    layout_label: 'Menu (Navigasi)',
    layout_header_label: 'Tipe Header',
    content_label: 'Konten',
    layout_navbar_label: 'Tipe Navbar',
...
window.onload = () => {
  ...
  // Guard: exit early if templateCustomizer was not initialized (e.g. constructor threw)
